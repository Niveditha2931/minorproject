      ...
      <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-gray-800 border-r border-gray-700 transition-all duration-300 flex flex-col`}>
        ...
        <div className="p-4 border-b border-gray-700">
          <Link to="/" className="flex items-center gap-3">
            ...
            {sidebarOpen && (
              <div>
                <h1 className="text-white font-bold">Crisis Response</h1>
        ...
        <div className="p-4 border-t border-gray-700">
          ...
          <button
            ...
            className={`mt-4 w-full flex items-center ${sidebarOpen ? 'gap-2' : 'justify-center'} px-4 py-2 text-gray-400 hover:text-white hover:bg-gray-700 rounded-lg transition-colors`}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          className="absolute top-6 -right-3 bg-gray-700 p-1 rounded-full border border-gray-600 text-gray-400 hover:text-white"
